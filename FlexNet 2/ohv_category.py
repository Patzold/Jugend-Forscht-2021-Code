...
if False:
    ...
    pickle_out = open((save_dir + "ohv_categorys_rubt_1.pickle"),"wb")
    pickle.dump(train, pickle_out)
    pickle_out.close()
    pickle_out = open((save_dir + "ohv_categorys_rubt_1t.pickle"),"wb")
    pickle.dump(test, pickle_out)
    pickle_out.close()
else:
    pickle_in = open(save_dir + "ohv_categorys_rubt_1.pickle","rb")
    train = pickle.load(pickle_in)
    pickle_in = open(save_dir + "ohv_categorys_rubt_1t.pickle","rb")
...
for epoch in range(EPOCHS):
    ...
    if osample > valid_acc_min and epoch > 10:
        ...
        torch.save(net.state_dict(), "C:/Cache/PJF-30/ohv_categorys_rubt_1.pt") #                                                  <-- UPDATE
...
plt.ylim([0, 1])
plt.savefig(("ohv_rubt_1.pdf")) #                                              <-- UPDATE
plt.show()