...
if True:
    ...
    pickle_out = open((save_dir + "classes_can_2.pickle"),"wb")
    pickle.dump(train, pickle_out)
    pickle_out.close()
    pickle_out = open((save_dir + "classes_can_2t.pickle"),"wb")
    pickle.dump(test, pickle_out)
    pickle_out.close()
else:
    pickle_in = open(save_dir + "classes_can_2.pickle","rb")
    train = pickle.load(pickle_in)
    pickle_in = open(save_dir + "classes_can_2t.pickle","rb")
...
for epoch in range(EPOCHS):
    ...
    if osample > valid_acc_min and epoch > 10:
        ...
        torch.save(net.state_dict(), "C:/Cache/PJF-30/categorys_can_2.pt") #                                                  <-- UPDATE
