...
pickle_in = open(save_dir + "intm_2_raw.pickle","rb")
train = pickle.load(pickle_in)
pickle_in = open(save_dir + "intm_2t_raw.pickle","rb")
...
for epoch in range(EPOCHS):
    ...
    if osample > valid_acc_min and epoch > 10:
        ...
        torch.save(net.state_dict(), "C:/Cache/PJF-25/3 MC only/intm_2.pt") #                                                  <-- UPDATE
...
# Max Out of Sample Accuracy: 0.803    4min 19s         3 - 192 - 96 - 3
# Max Out of Sample Accuracy: 0.803    4min 18s         3 - 96 - 48 - 3
# Max Out of Sample Accuracy: 0.726    3min 53s         3 - 48 - 24 - 3
# Max Out of Sample Accuracy: 0.794    4min 16s         3 - 24 - 12 - 3
# Max Out of Sample Accuracy: 0.794    3min 48s         3 - 12 - 6 - 3