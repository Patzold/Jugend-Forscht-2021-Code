...
if False:
    ...
    pickle_out = open((save_dir + "std_lego.pickle"),"wb")
    pickle.dump(train, pickle_out)
    pickle_out.close()
    pickle_out = open((save_dir + "std_legot.pickle"),"wb")
...
for epoch in range(EPOCHS):
    ...
    torch.save(model.state_dict(), "C:/Cache/PJF-30/std_ResNet-50_lego_CHECKPOINT.pt")
    ...
    if osample > valid_acc_min and epoch > 10:
        ...
        torch.save(model.state_dict(), "C:/Cache/PJF-30/std_ResNet-50_lego.pt") #                                                  <-- UPDATE
...
plt.ylim([0, 1])
plt.savefig(("std_ResNet-50_lego.pdf")) #                                              <-- UPDATE
plt.show()

# Max Out of Sample Accuracy: 0.928            5h 12min 54s
# [110, 117, 114, 118, 97, 104, 120, 102, 89, 129, 116, 80, 88, 0, 0, 0, 0, 0]