...
if True:
    ...
    pickle_out = open((save_dir + "classes_pig.pickle"),"wb")
    pickle.dump(train, pickle_out)
    pickle_out.close()
    pickle_out = open((save_dir + "classes_pigt.pickle"),"wb")
    pickle.dump(test, pickle_out)
    pickle_out.close()
else:
    pickle_in = open(save_dir + "classes_pig.pickle","rb")
    train = pickle.load(pickle_in)
    pickle_in = open(save_dir + "classes_pigt.pickle","rb")
