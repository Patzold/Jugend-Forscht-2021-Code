...
if False:
    ...
    pickle_out = open((save_dir + "fl_baseline.pickle"),"wb")
    pickle.dump(train, pickle_out)
    pickle_out.close()
    pickle_out = open((save_dir + "fl_baseline_t.pickle"),"wb")
    pickle.dump(test, pickle_out)
    pickle_out.close()
else:
    pickle_in = open(save_dir + "fl_baseline.pickle","rb")
    train = pickle.load(pickle_in)
    pickle_in = open(save_dir + "fl_baseline_t.pickle","rb")
